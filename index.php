<?// The blacklisted ips. if positve match for ip or fileted host names then they get logged to blacklistlogged.html then redirected to unauthorized.php
$denied_ips = array(
   '159.69.91.3',
   '116.203.43.244',
   '54.37.73.136',
...
<!-- if they do not get redorected then this LOGS All users to vistorIp.html for later evaulatuon -->
<?php
